...
namespace SpeakerApp.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var speakerViewModel = new SpeakerViewModel()
            {
                ...
                SpeakingTime = speaker.SpeakingTime,
                Venue = speaker.Venue,
                ExistingImage = speaker.ProfilePicture!=null? speaker.ProfilePicture:null
            };
            if (speaker == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                CurrentImage = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot\\images", speaker.ProfilePicture);
            }
